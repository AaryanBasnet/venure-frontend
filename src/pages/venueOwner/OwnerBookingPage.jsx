...
const ConfirmModal = ({ message, onConfirm, onCancel, isLoading, type = "cancel" }) => (
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">There was an error loading your bookings. Please try again.</p>
            <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage and track all your venue bookings</p>
            </div>
                ...
                <div key={booking._id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium text-gray-900 capitalize">{booking.eventType}</div>
                    </div>
                    <div>
                      <div className="text-xs text-gray-500 uppercase tracking-wider">Guests</div>
                      <div className="text-sm font-medium text-gray-900">{booking.numberOfGuests}</div>
                    </div>
                  </div>
