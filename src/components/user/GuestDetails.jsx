...
const GuestDetailsPage = () => {
  ...
  return (
    <>
      ...
      <div className="mb-6">
        <label htmlFor="numGuests" className="block text-xl font-medium text-gray-800 mb-4">
          Number of Guests
        </label>
        <input
          type="number"
      ...
      <div className="mb-6">
        <label htmlFor="eventType" className="block text-xl font-medium text-gray-800 mb-4">
          Event Type
        </label>
        <select
          id="eventType"
      ...
      <div className="mb-6">
        <label htmlFor="specialRequirements" className="block text-xl font-medium text-gray-800 mb-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="contactName" className="block text-gray-700 text-sm font-medium mb-1">
              Contact Name
            </label>
            <input
              type="text"
